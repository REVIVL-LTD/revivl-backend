 ...
 */
final class Version20220614181253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, doctor_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, abbreviation VARCHAR(10) NOT NULL, cost INT NOT NULL, photo VARCHAR(255) DEFAULT NULL, status INT NOT NULL, PRIMARY KEY(id))');
