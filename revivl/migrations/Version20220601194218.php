 ...
 */
final class Version20220601194218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE code_auth (id INT NOT NULL, code INT NOT NULL, email VARCHAR(255) NOT NULL, live_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
